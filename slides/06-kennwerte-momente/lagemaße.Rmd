...
### Lernziele: Kennwerte, Lage & Streuung

Nach diesem Kapitel können Sie ...

- Lage- und Streuungsmaße berechnen und ihre Robustheit gegen Ausreißer beurteilen
- Boxplots konstruieren und ablesen
- Verteilungsform (Schiefe, Modalität) aus Kennwerten und Grafiken diagnostizieren
- Konzentration mit Lorenzkurve und Gini-Koeffizient messen

\vspace{1em}

**Voraussetzungen:** Häufigkeiten & empirische Verteilungen (Kap. 4).
...
Wachstums\emph{faktoren} multiplizieren sich $\longrightarrow$ *geometrisches* Mittel;
Prozent\emph{punkt}-Differenzen addieren sich (Prozente vs. Prozentpunkte: siehe Kap. 3).
:::
...
<!-- $\implies \log(\bar x) \geq \overline{\log(x)}$   -->
<!-- $\implies \bar x \geq \exp\left(\overline{log(x)}\right) = \exp -->
<!-- \left(\frac{1}{n} \sum_{i=1}^n \log(x_i)\right)$   -->
<!-- $\phantom{\implies x}= \left(\prod_{i=1}^n  -->
...
<!-- $\implies \frac{1}{\sqrt[n]{\prod\limits_{i=1}^n x_i}} \leq -->
<!-- \frac{1}{n} \sum\limits_{i=1}^n \frac{1}{x_i}$   -->
<!-- $\implies \underbrace{\sqrt[n]{\prod\limits_{i=1}^n x_i}}_{\bar x_G} \geq -->
