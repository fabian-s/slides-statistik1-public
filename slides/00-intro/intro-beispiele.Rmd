...
### Lernziele: Was ist Statistik?

Nach diesem Kapitel können Sie ...

- die drei Aufgaben der Statistik -- **Deskription**, **Exploration** und **Induktion** -- unterscheiden und je ein Beispiel zuordnen
- typische **Anwendungsfelder** statistischer Datenanalyse (Wahlprognosen, klinische Studien, maschinelles Lernen, ...) erkennen
- benennen, welche **Frage** eine Analyse jeweils beantwortet: beschreiben, Strukturen suchen oder auf die Grundgesamtheit verallgemeinern
- **Grenzen und Missbrauchsmöglichkeiten** von Datenanalysen kritisch einordnen (Verzerrung, Fehlinterpretation, Manipulation)

### Roter Faden: Schlaf im ersten Semester

**Frage:** Wie viel schlafen Erstsemester -- und hängt die Schlafdauer mit
der selbstberichteten Schlafqualität (oder dem Studiengang) zusammen?

>- **Deskription:** Wie sind Schlafdauer & -qualität in der Stichprobe verteilt?
>- **Exploration:** Gibt es einen Zusammenhang zwischen Dauer und Qualität?
>- **Induktion:** Lässt sich von den Befragten auf *alle* Erstsemester schließen?

\vspace{.5em}

An dieser alltagsnahen Fragestellung illustrieren wir im Verlauf der Vorlesung
immer wieder neue Konzepte. Den ersten Schritt machen Sie selbst: **Blatt 1**
analysiert eine solche Schlaf-Umfrage unter Studienanfänger:innen.


### Bundestagswahl 2021 -- Prognose vs.\ Ergebnis (Fallbeispiel)
...
### Bundestagswahl 2021 -- Fragestellungen

Historisches Fallbeispiel -- dasselbe Prinzip wiederholt sich bei jeder Wahl
(zuletzt Bundestagswahl 2025):

*  Schluss von der Befragung einer Stichprobe von Wähler:innen auf das Gesamtergebnis
...
**Schritt 1:** Mehrere aktuelle Umfragen werden zu einem gemeinsamen Schätzwert
je Partei gebündelt -- einzelne Umfragen schwanken, die Bündelung glättet.
...
**Schritt 2:** Aus vielen simulierten Wahlausgängen ergibt sich die
*Wahrscheinlichkeit* einer Sitzmehrheit für eine Koalition -- und wie sie sich
...
* In verarbeiteten Produkten wurden Verfälschungen, u.a. durch Cashews/Mandeln gefunden, hohes Gesundheitsrisiko (Allergie)
...
### Wirkung der Umweltzone: zwei Messstationen
