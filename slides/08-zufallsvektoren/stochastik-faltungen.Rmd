...
::: {.block}
#### Def: Faltung von stochastisch unabhängigen, diskreten Zufallsvariablen
...
>- **Träger:** $T_Z = \{2, 3, 4, \dots\}$ (mindestens 2 Versuche für 2 Erfolge).
>- **W.keitsfunktion:** $f_Z(z) = \sum_{x=1}^{z-1} \pi(1-\pi)^{x-1}\, \pi(1-\pi)^{z-x-1} = (z-1)\,\pi^2 (1-\pi)^{z-2}$
>- **Interpretation:** $Z$ ist die Anzahl der Versuche bis zum **2. Erfolg** (Summe zweier Wartezeiten).
