...
1. Welche Voraussetzungen braucht der ZGWS?
2. Wozu braucht man die *endliche Varianz*?
3. Gilt der ZGWS auch für diskrete oder schiefe $X_i$?

\vspace{0.5em}

>- **1.** i.i.d. Zufallsvariablen mit *existierendem* Erwartungswert und *endlicher* Varianz --- die datengenerierende Verteilung selbst ist beliebig.
>- **2.** Nur dann gilt $\Var(\bar X_n) = \sigma^2/n \to 0$; ohne endliche Varianz (z.B. Cauchy) konvergiert das Mittel nicht --- weder GGZ noch ZGWS greifen.
>- **3.** Ja --- solange $E(X_i)$ und $\Var(X_i)$ existieren, ist die Form der Verteilung (diskret, schief, multimodal) egal.
