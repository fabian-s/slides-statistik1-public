...
mietspiegel_url <- "../data/mietspiegel2015.txt"
...
$\implies k=n$ und $\{x_1 , \ldots , x_n\} = \{a_1 , \ldots , a_k\};\; f_j = \frac{1}{`r nrow(klein_und_kalt)`} \,\forall\,  j = 1, \ldots, `r nrow(klein_und_kalt)`$.
