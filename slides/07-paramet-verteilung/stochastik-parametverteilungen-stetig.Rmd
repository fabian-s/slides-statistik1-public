...
$$X_i \sim \mathcal{N}(\mu_i, \sigma_i^2) \implies \sum_i X_i \sim \mathcal{N}\left(\sum_i \mu_i, \sum_i \sigma_i^2\right)$$^[Varianz ist Summe der Varianzen nur wenn $X_i$ unabhängig.]
...
>- **Der Erwartungswert existiert nicht:** Das arithmetische Mittel von Cauchy-Stichproben pendelt sich auch für sehr große $n$ **nie** auf einen festen Wert ein --- es ist selbst wieder Cauchy-verteilt. Damit versagt das Gesetz der großen Zahlen (Gegenbeispiel in Kap. 9).
...
### Welche Verteilung passt?

Von der **datengenerierenden Geschichte** zur Verteilungsfamilie:
