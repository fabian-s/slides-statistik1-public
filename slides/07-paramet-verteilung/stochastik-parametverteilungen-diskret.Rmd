### Lernziele: Wichtige parametrische Verteilungen

Nach diesem Kapitel können Sie ...

- zu einem gegebenen Zufallsvorgang die passende Verteilungsfamilie erkennen und die Wahl begründen
- Wahrscheinlichkeiten, Erwartungswerte und Quantile der wichtigen Verteilungen von Hand und in R berechnen
- Beziehungen zwischen Verteilungen (Approximationen, Grenzübergänge) erkennen und nutzen

\vspace{1em}

**Voraussetzungen:** Zufallsvariablen & Verteilungsfunktionen (Kap. 4), Erwartungswert & Varianz (Kap. 6)
