...
Ist der **Durchschnitt von Postleitzahlen** eine sinnvolle Größe?

>- Ist die mittlere Trikotnummer einer Fußballmannschaft interpretierbar?
>- Sind 20 °C *doppelt so warm* wie 10 °C?
>- Der Median von Schulnoten ("sehr gut" ... "ungenügend") ist interpretierbar --- das arithmetische Mittel auch?

\vspace{1em}

>- **Welche Rechnungen sinnvoll sind, hängt vom *Skalenniveau* des Merkmals ab --- nicht davon, ob sich die Ausprägungen als Zahlen schreiben lassen.**
...
- erlauben eine *größere* Menge von sinnvollen *Operationen mit Werten auf der Skala*,
- aber eine *kleinere* Menge an zulässigen strukturerhaltenden *Transformationen der Skala selbst*.
